# Diablo
  ...
  Spooky Shrine        | Where avarice fails, patience brings reward   (user) — Blessed by a benevolent companion             (others)
  Stone Shrine         | The Power of mana refocused renews
  Tainted              | Those who are last may yet be first           (user) — Generosity brings its own reward              (others)
